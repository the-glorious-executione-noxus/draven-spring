...
public class PDFBoxDemo
{
    ...
    public static void main( String[] args ) throws Exception {
        try {
            ...
            PDImageXObject pdImage = PDImageXObject.createFromFile("draven-springboot/noxus-draven-springboot-2.2.x/noxus-draven-document/com-noxus-draven-dfboxdemo/src/main/resources/song.png", document);
            ...
            // Saving the document
            document.save(new File("new_VAT_INVOICE.pdf"));
