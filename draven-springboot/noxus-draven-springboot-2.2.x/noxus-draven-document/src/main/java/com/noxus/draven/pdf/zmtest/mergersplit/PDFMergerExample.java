package com.noxus.draven.pdf.zmtest.mergersplit;
...
public class PDFMergerExample {
	...
	public InputStream merge(final List<InputStream> sources) throws IOException {
		...
		try {
			// If you're merging in a servlet, you can modify this example to
			// use the outputStream only
			// as the response as shown here:
			// http://stackoverflow.com/a/36894346/535646
